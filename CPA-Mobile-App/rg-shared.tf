...
module "avm-res-keyvault-vault-shared" {
  ...
  # Enable soft delete and purge protection for security
  soft_delete_retention_days        = 90
  purge_protection_enabled          = true

  # Network ACLs to deny public access by default
  network_acls = {
...
# -------------------------------------------------
# Module to create AVM Azure Service Bus Namespace
# -------------------------------------------------
module "avm-res-servicebus-namespace-shared" {
  ...
  # # Disable local authentication (SAS tokens) - use Azure AD instead
  # local_auth_enabled                = false
}

# ------------------------------------------------------------
# Azurerm - Service Bus Topic (Course)
# ------------------------------------------------------------
resource "azurerm_servicebus_topic" "shared_course_topic" {
  ...
  default_message_ttl               = local.servicebus_default_message_ttl
  batched_operations_enabled        = true
}

# ------------------------------------------------------------
# Azurerm - Service Bus Topic (CAS Notification)
# ------------------------------------------------------------
resource "azurerm_servicebus_topic" "shared_notification_topic" {
  name                              = local.servicebus_topic_name_shared_notification
  namespace_id                      = module.avm-res-servicebus-namespace-shared.resource_id
  default_message_ttl               = local.servicebus_default_message_ttl
  batched_operations_enabled        = true
}
...
# ------------------------------------------------------------
# Azurerm - Service Bus Topic (CAS Tasks)
# ------------------------------------------------------------
resource "azurerm_servicebus_topic" "shared_cas_tasks_topic" {
  name                              = local.servicebus_topic_name_shared_cas_tasks
  namespace_id                      = module.avm-res-servicebus-namespace-shared.resource_id
  default_message_ttl               = local.servicebus_default_message_ttl
  batched_operations_enabled        = true
}
...
# ------------------------------------------------------------
# Azurerm - Service Bus Topic (sitecore-content-webhook)
# ------------------------------------------------------------
resource "azurerm_servicebus_topic" "shared_sitecore_content_webhook_topic" {
  name                              = local.servicebus_topic_name_shared_sitecore_content_webhook
  namespace_id                      = module.avm-res-servicebus-namespace-shared.resource_id
  default_message_ttl               = local.servicebus_default_message_ttl
  batched_operations_enabled        = true
}
...
# ------------------------------------------------------------
# Azurerm - Service Bus Queue (Podcast)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Azurerm - Service Bus Queue (Sitecore - LMS Events)
# ------------------------------------------------------------
resource "azurerm_servicebus_queue" "shared_sitecore_lms_events_queue" {
  name                              = local.servicebus_queue_name_shared_sitecore_lms_events
  namespace_id                      = module.avm-res-servicebus-namespace-shared.resource_id
  default_message_ttl               = local.servicebus_default_message_ttl
  partitioning_enabled              = false  
  max_delivery_count                = 10
...
# ------------------------------------------------------------
# Azurerm - Service Bus Subscription (Course)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Azurerm - Service Bus Subscription (Notification)
# ------------------------------------------------------------
resource "azurerm_servicebus_subscription" "shared_notification_subscription" {
  name                                      = local.servicebus_subscription_name_shared_notification
  topic_id                                  = azurerm_servicebus_topic.shared_notification_topic.id
  auto_delete_on_idle                       = "P10675198DT2H48M5S"
  batched_operations_enabled                = true
  dead_lettering_on_filter_evaluation_error = false
  default_message_ttl                       = local.servicebus_default_message_ttl
...
# ------------------------------------------------------------
# Azurerm - Service Bus Subscriptions (CAS Notification preflight rule)
# ------------------------------------------------------------
resource "azurerm_servicebus_subscription" "shared_notification_preflight_subscription" {
  name                                      = local.servicebus_subscription_name_shared_notification_preflight
  topic_id                                  = azurerm_servicebus_topic.shared_notification_topic.id
  auto_delete_on_idle                       = "P10675198DT2H48M5S"
  batched_operations_enabled                = true
  dead_lettering_on_filter_evaluation_error = false
...
# ------------------------------------------------------------
# Azurerm - Service Bus Subscriptions (CAS Tasks)
# ------------------------------------------------------------
resource "azurerm_servicebus_subscription" "shared_cas_tasks_broadcast_subscription" {
  name                                      = local.servicebus_subscription_name_shared_cas_tasks_broadcast
  topic_id                                  = azurerm_servicebus_topic.shared_cas_tasks_topic.id
  auto_delete_on_idle                       = "P10675198DT2H48M5S"
  batched_operations_enabled                = true
  dead_lettering_on_filter_evaluation_error = false
  default_message_ttl                       = local.servicebus_default_message_ttl
...
resource "azurerm_servicebus_subscription" "shared_cas_tasks_preflight_subscription" {
  name                                      = local.servicebus_subscription_name_shared_cas_tasks_preflight
  topic_id                                  = azurerm_servicebus_topic.shared_cas_tasks_topic.id
  auto_delete_on_idle                       = "P10675198DT2H48M5S"
  batched_operations_enabled                = true
  dead_lettering_on_filter_evaluation_error = false
...
resource "azurerm_servicebus_subscription" "shared_cas_tasks_register_all_subscription" {
  name                                      = local.servicebus_subscription_name_shared_cas_tasks_register_all
  topic_id                                  = azurerm_servicebus_topic.shared_cas_tasks_topic.id
  auto_delete_on_idle                       = "P10675198DT2H48M5S"
  batched_operations_enabled                = true
  dead_lettering_on_filter_evaluation_error = false
...
# ------------------------------------------------------------
# Azurerm - Service Bus Subscription Rule (Course)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# Azurerm - Service Bus Subscription Rule (CAS Tasks)
# ------------------------------------------------------------
resource "azurerm_servicebus_subscription_rule" "shared_cas_tasks_broadcast_rule" {
  name                              = local.servicebus_subscription_rule_name_shared_cas_tasks_broadcast
  subscription_id                   = azurerm_servicebus_subscription.shared_cas_tasks_broadcast_subscription.id
  filter_type                       = "SqlFilter"
  sql_filter                        = "sys.Label='cas.tasks.broadcastnotification'"
}

resource "azurerm_servicebus_subscription_rule" "shared_cas_tasks_preflight_rule" {
  name                              = local.servicebus_subscription_rule_name_shared_cas_tasks_preflight
  subscription_id                   = azurerm_servicebus_subscription.shared_cas_tasks_preflight_subscription.id
  filter_type                       = "SqlFilter"
  sql_filter                        = "sys.Label='cas.tasks.broadcastnotification.preflight'"
}

resource "azurerm_servicebus_subscription_rule" "shared_cas_tasks_register_all_rule" {
  name                              = local.servicebus_subscription_rule_name_shared_cas_tasks_register_all
  subscription_id                   = azurerm_servicebus_subscription.shared_cas_tasks_register_all_subscription.id
  filter_type                       = "SqlFilter"
  sql_filter                        = "sys.Label='cas.tasks.registernotificationtemplatesforall'"
}

# ------------------------------------------------------------
# Azurerm - Service Bus Subscription Rule (CAS Notification)
# ------------------------------------------------------------
resource "azurerm_servicebus_subscription_rule" "shared_notification_notification_rule" {
  name                              = local.servicebus_subscription_rule_name_shared_notification
  subscription_id                   = azurerm_servicebus_subscription.shared_notification_subscription.id
...
resource "azurerm_servicebus_subscription_rule" "shared_notification_preflight_rule" {
  name                              = local.servicebus_subscription_rule_name_shared_notification_preflight
  subscription_id                   = azurerm_servicebus_subscription.shared_notification_preflight_subscription.id
  filter_type                       = "CorrelationFilter"
  correlation_filter {
      properties = {
        IsPreflight = "True"
...
# ------------------------------------------------------------
resource "azurerm_cosmosdb_sql_container" "shared_cosmos_sql_container_notifications" {
...
# ------------------------------------------------------------
# Azurerm - Manages a SQL Container (preflight notifications) 
# ------------------------------------------------------------
resource "azurerm_cosmosdb_sql_container" "shared_cosmos_sql_container_preflight_notifications" {
  name                              = local.cosmosdb_sql_container_notify_preflight_name_shared
  resource_group_name               = module.avm-res-resources-resourcegroup-shared.name
  account_name                      = azurerm_cosmosdb_account.shared_cosmos.name
  database_name                     = azurerm_cosmosdb_sql_database.shared_cosmos_sql_db.name
  partition_key_paths               = [local.cosmosdb_sql_container_partition_key_paths_shared]

  default_ttl                       = 86400  # 1 days
